...
try {
  ...
  // If we are in an ESM environment without CommonJS globals
  if (!safeFilename) {
    const url = import.meta.url;
    if (url) {
      safeFilename = fileURLToPath(url);
      safeDirname = path.dirname(safeFilename);
    }
  }
} catch (e) {
  console.warn("Error resolving __filename / __dirname:", e);
}

// Fallbacks if both failed
const __filename = safeFilename || path.join(process.cwd(), "server.ts");
const __dirname = safeDirname || process.cwd();
...
if (process.env.NODE_ENV === "production") {
  const seoData: Record<string, { title: string; desc: string; canonical: string; schema: any }> = {
    "/": {
      title: "Bespoke UI/UX Design & High-Performance Front-End Engineering | xnui",
      desc: "Bespoke digital design studio led by Sofia Varian. We craft high-fidelity tactile UI/UX, mathematical layouts, adaptive systems, and ultra-smooth performance animations.",
      canonical: "/",
      schema: {
        "@context": "https://schema.org",
        "@type": "ProfessionalService",
        "name": "xnui",
        "image": "https://xnui.com/logo.png",
        "url": "https://xnui.com/",
        "telephone": "",
        "address": {
          "@type": "PostalAddress",
    ...
    "/services": {
      title: "Tactical UI/UX & Digital Brand Strategy Services | xnui Studio",
      desc: "Comprehensive solutions including cognitive friction analysis, Golden Scale typography engineering, chromatic math APCA contrast auditing, and custom physics animations.",
      canonical: "/services",
      schema: {
        "@context": "https://schema.org",
        "@type": "Service",
        "name": "Bespoke Design & Engineering Services",
        ...
        "description": "Premium boutique design systems, usability mapping, contrast compliance auditing, and interaction engineering services."
      }
    },
    "/laboratory": {
      title: "UI/UX Laboratory & Fluid Interaction Experiments | xnui",
      desc: "Interactive experiments in digital craft. Test real-time kinetic friction, mass-spring-damper haptics, color APCA contrast, and physical typography scaling.",
      canonical: "/laboratory",
      schema: {
        "@context": "https://schema.org",
        "@type": "WebPage",
        "name": "UI/UX Laboratory & Physics Playground",
        "url": "https://xnui.com/laboratory",
        "description": "A live-rendered sandbox of interactive frontend engineering experiments focusing on cognitive friction and spring haptics."
      }
    },
    "/services/ux-design": {
      title: "Bespoke UI/UX Design & Human-Computer Interaction | xnui",
      desc: "User experience engineering focused on cognitive load reduction, tap target layout optimization, and spatial physics designed to keep users engaged and delighted.",
      canonical: "/services/ux-design",
      schema: {
        "@context": "https://schema.org",
        "@type": "Service",
        "name": "Human-Computer Interaction & UX Engineering",
        ...
        "description": "Bespoke UI/UX Design and human-computer interaction services centering spatial haptics and latency tuning.",
        "serviceType": "UX Design, Interface Engineering"
      }
    },
    "/services/brand-strategy": {
      title: "Bespoke Brand Strategy & Visual Identity Design | xnui Studio",
      desc: "Transforming startups into iconic brands with mathematical layout systems, responsive typography grids, and scientific color theory built for perfect APCA readability.",
      canonical: "/services/brand-strategy",
      schema: {
        "@context": "https://schema.org",
        "@type": "Service",
        "name": "Mathematical Brand Strategy & Visual Identity",
        ...
        "description": "Scientific brand architectures utilizing the Fibonacci golden scale for typography and APCA algorithms for visual contrast.",
        "serviceType": "Brand Strategy, Visual Design"
      }
    },
